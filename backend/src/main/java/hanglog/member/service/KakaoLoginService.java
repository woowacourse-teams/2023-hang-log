...
public class KakaoLoginService extends LoginService {
    ...
    private static final String PROPERTIES_PATH = "${spring.oauth2.client.registration.kakao.";
    ...
    public UserInfoDto getUserInfo(final String accessToken) {
        ...
        return restTemplate.exchange(userUri, HttpMethod.GET, entity, KakaoUserInfoResponseDto.class).getBody();
    }
}

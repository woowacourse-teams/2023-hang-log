...
==== 요청
include::{snippets}/oauth-controller-test/login/http-request.adoc[]
include::{snippets}/oauth-controller-test/login/path-parameters.adoc[]
include::{snippets}/oauth-controller-test/login/request-fields.adoc[]

==== 응답
include::{snippets}/oauth-controller-test/login/http-response.adoc[]
응답 쿠키
include::{snippets}/oauth-controller-test/login/response-cookies.adoc[]
include::{snippets}/oauth-controller-test/login/response-fields.adoc[]

=== 토큰 재발급 (POST /token)

==== 요청
include::{snippets}/oauth-controller-test/extend-login/http-request.adoc[]
요청 쿠키
include::{snippets}/oauth-controller-test/extend-login/request-cookies.adoc[]
include::{snippets}/oauth-controller-test/extend-login/request-fields.adoc[]

==== 응답
include::{snippets}/oauth-controller-test/extend-login/http-response.adoc[]
include::{snippets}/oauth-controller-test/extend-login/response-fields.adoc[]

=== 로그아웃 (POST /logout)

==== 요청
include::{snippets}/oauth-controller-test/logout/http-request.adoc[]
요청 헤더
include::{snippets}/oauth-controller-test/logout/request-headers.adoc[]
요청 쿠키
include::{snippets}/oauth-controller-test/logout/request-cookies.adoc[]

==== 응답
include::{snippets}/oauth-controller-test/logout/http-response.adoc[]

=== 회원 탈퇴 (DELETE /account)

==== 요청
include::{snippets}/oauth-controller-test/delete-account/http-request.adoc[]
요청 헤더
include::{snippets}/oauth-controller-test/delete-account/request-headers.adoc[]
요청 쿠키
include::{snippets}/oauth-controller-test/delete-account/request-cookies.adoc[]

==== 응답
include::{snippets}/oauth-controller-test/delete-account/http-response.adoc[]
